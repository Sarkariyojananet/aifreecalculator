...
const LABELS = {
  ...
  fr: {
    ...
    notesSection: 'Conseils clés et considéraciones pratiques',
    scenario: 'Scénario :',
...
const sampleEmiHi = JSON.parse(fs.readFileSync('./src/i18n/translations/calculators/data/emi-calculator.json', 'utf8')).hi;
const generated = generateArticleHtml(sampleEmiHi, 'hi');
