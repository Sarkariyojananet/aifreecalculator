...
import { calculateCylinderVolume as calculateStandaloneCylinderVolume } from '../calculators/cylinder-volume';
...
// ─── Exponential Form Calculator Tests ────────────────────────────────────────
const exponentialFormTests: CalculatorTestCase[] = [
  {
    slug: 'exponential-form-calculator',
    name: 'Prime Factorization (128 = 2⁷)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'exponentialFormUnicode',
    expectedValue: '2⁷',
    tolerance: 0,
    description: '128 converts to 2⁷ in exponential form.',
    run: () => calculateWholeNumberExponentialForm(128),
  },
  {
    slug: 'exponential-form-calculator',
    name: 'Prime Factorization (72 = 2³ × 3²)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'exponentialFormUnicode',
    expectedValue: '2³ × 3²',
    tolerance: 0,
    description: '72 converts to 2³ × 3².',
    run: () => calculateWholeNumberExponentialForm(72),
  },
  {
    slug: 'exponential-form-calculator',
    name: 'Prime Factorization (250 = 2 × 5³)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'exponentialFormUnicode',
    expectedValue: '2 × 5³',
    tolerance: 0,
    description: '250 converts to 2 × 5³.',
    run: () => calculateWholeNumberExponentialForm(250),
  },
  {
    slug: 'exponential-form-calculator',
    name: 'Prime Factorization (360 = 2³ × 3² × 5)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'exponentialFormUnicode',
    expectedValue: '2³ × 3² × 5',
    tolerance: 0,
    description: '360 converts to 2³ × 3² × 5.',
    run: () => calculateWholeNumberExponentialForm(360),
  },
  {
    slug: 'exponential-form-calculator',
    name: 'Prime Number Factorization (13 = 13)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'isPrime',
    expectedValue: true,
    tolerance: 0,
    description: '13 is prime and its exponential form is 13.',
    run: () => calculateWholeNumberExponentialForm(13),
  },
  {
    slug: 'exponential-form-calculator',
    name: 'Log to Exponential Form (log₂(8) = 3 -> 2³ = 8)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'exponentialExpression',
    expectedValue: '2³ = 8',
    tolerance: 0,
    description: 'log₂(8) = 3 converts to 2³ = 8.',
    run: () => calculateLogToExponential(2, 8, 3),
  },
  {
    slug: 'exponential-form-calculator',
    name: 'Log to Exponential Form (log₅(125) = 3 -> 5³ = 125)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'exponentialExpression',
    expectedValue: '5³ = 125',
    tolerance: 0,
    description: 'log₅(125) = 3 converts to 5³ = 125.',
    run: () => calculateLogToExponential(5, 125, 3),
  },
  {
    slug: 'exponential-form-calculator',
    name: 'Exponential to Logarithmic Form (2⁵ = 32 -> log₂(32) = 5)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'logExpression',
    expectedValue: 'log₂(32) = 5',
    tolerance: 0,
    description: '2⁵ = 32 converts to log₂(32) = 5.',
    run: () => calculateExponentialToLog(2, 5, 32),
  },
  {
    slug: 'exponential-form-calculator',
    name: 'Exponential to Logarithmic Form (3⁴ = 81 -> log₃(81) = 4)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'logExpression',
    expectedValue: 'log₃(81) = 4',
    tolerance: 0,
    description: '3⁴ = 81 converts to log₃(81) = 4.',
    run: () => calculateExponentialToLog(3, 4, 81),
  },
];

const exponentialFunctionTests: CalculatorTestCase[] = [
  {
    slug: 'exponential-function-calculator',
    name: 'Solve f(x)=a*b^x from (0,2) and (1,4)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'equationDisplay',
    expectedValue: 'f(x) = 2 × 2^x',
    tolerance: 0,
    description: 'Points (0, 2) and (1, 4) determine f(x) = 2 · 2ˣ with a = 2 and b = 2.',
    run: () => solveStandardExponentialFromPoints(0, 2, 1, 4),
  },
  {
    slug: 'exponential-function-calculator',
    name: 'Solve f(x)=a*b^x from (0,4) and (1,12)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'equationDisplay',
    expectedValue: 'f(x) = 4 × 3^x',
    tolerance: 0,
    description: 'Points (0, 4) and (1, 12) determine f(x) = 4 · 3ˣ with a = 4 and b = 3.',
    run: () => solveStandardExponentialFromPoints(0, 4, 1, 12),
  },
  {
    slug: 'exponential-function-calculator',
    name: 'Evaluate f(x)=2*3^x at x=2',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'y',
    expectedValue: 18,
    tolerance: 0,
    description: 'f(2) = 2 · 3² = 18.',
    run: () => evaluateStandardExponential(2, 3, 2),
  },
  {
    slug: 'exponential-function-calculator',
    name: 'Evaluate f(x)=5*2^x at x=3',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'y',
    expectedValue: 40,
    tolerance: 0,
    description: 'f(3) = 5 · 2³ = 40.',
    run: () => evaluateStandardExponential(5, 2, 3),
  },
  {
    slug: 'exponential-function-calculator',
    name: 'Evaluate f(x)=2*e^(0.5x) at x=2',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'y',
    expectedValue: 5.4365636569,
    tolerance: 1e-4,
    description: 'f(2) = 2 · e^(0.5 · 2) = 2 · e¹ ≈ 5.43656.',
    run: () => evaluateNaturalExponential(2, 0.5, 2),
  },
  {
    slug: 'exponential-function-calculator',
    name: 'Solve f(x)=a*e^(cx) with Base e from (0,2) and (2, 2e)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'c',
    expectedValue: 0.5,
    tolerance: 1e-6,
    description: 'Two points (0, 2) and (2, 2e) give c = 0.5 and a = 2.',
    run: () => solveNaturalExponentialFromPoints(0, 2, 2, 2 * Math.E),
  },
  {
    slug: 'exponential-function-calculator',
    name: 'Negative Y values solve: (0, -2) and (1, -6)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'a',
    expectedValue: -2,
    tolerance: 0,
    description: '(0, -2) and (1, -6) give valid real exponential f(x) = -2 · 3ˣ.',
    run: () => solveStandardExponentialFromPoints(0, -2, 1, -6),
  },
  {
    slug: 'exponential-function-calculator',
    name: 'Constant function when y1 = y2: (1, 5) and (3, 5)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'isConstant',
    expectedValue: true,
    tolerance: 0,
    description: 'When y₁ = y₂, b = 1 representing constant horizontal function f(x) = 5.',
    run: () => solveStandardExponentialFromPoints(1, 5, 3, 5),
  },
  {
    slug: 'exponential-function-calculator',
    name: 'Error when x1 = x2',
    category: 'Boundary',
    expectedBehavior: 'throw',
    expectedResultKey: 'error',
    expectedValue: 'x₁ and x₂ cannot be equal',
    tolerance: 0,
    description: 'x₁ = x₂ must throw an error.',
    run: () => solveStandardExponentialFromPoints(2, 4, 2, 8),
  },
  {
    slug: 'exponential-function-calculator',
    name: 'Error when y1 and y2 have opposite signs',
    category: 'Boundary',
    expectedBehavior: 'throw',
    expectedResultKey: 'error',
    expectedValue: 'opposite y-signs',
    tolerance: 0,
    description: 'Opposite y-signs require non-real negative base, throwing error.',
    run: () => solveStandardExponentialFromPoints(0, 2, 1, -4),
  },
];

const exponentialGrowthTests: CalculatorTestCase[] = [
  {
    slug: 'exponential-growth-calculator',
    name: 'Population Growth (10,000 at 5% for 11 years)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'finalQuantity',
    expectedValue: 17103,
    tolerance: 1,
    description: '10,000 * (1.05)^11 ≈ 17,103.39',
    run: () => calculateExponentialGrowth({ solveFor: 'final', initialQuantity: 10000, growthRate: 5, timePeriods: 11 }),
  },
  {
    slug: 'exponential-growth-calculator',
    name: 'Simple Growth (100 at 10% for 2 periods)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'finalQuantity',
    expectedValue: 121,
    tolerance: 0,
    description: '100 * (1.10)^2 = 121',
    run: () => calculateExponentialGrowth({ solveFor: 'final', initialQuantity: 100, growthRate: 10, timePeriods: 2 }),
  },
  {
    slug: 'exponential-growth-calculator',
    name: 'Exponential Decay (100 at -10% for 2 periods)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'finalQuantity',
    expectedValue: 81,
    tolerance: 0,
    description: '100 * (0.90)^2 = 81',
    run: () => calculateExponentialGrowth({ solveFor: 'final', initialQuantity: 100, growthRate: -10, timePeriods: 2 }),
  },
  {
    slug: 'exponential-growth-calculator',
    name: 'Solve for Rate (100 to 121 in 2 periods)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'growthRatePercent',
    expectedValue: 10,
    tolerance: 0.01,
    description: 'Solve rate: 100 * (1+r/100)^2 = 121 -> r = 10%',
    run: () => calculateExponentialGrowth({ solveFor: 'rate', initialQuantity: 100, finalQuantity: 121, timePeriods: 2 }),
  },
  {
    slug: 'exponential-growth-calculator',
    name: 'Solve for Time (100 to 200 at 10%)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'timePeriods',
    expectedValue: 7.27,
    tolerance: 0.05,
    description: 'Solve time: 100 * (1.1)^t = 200 -> t ≈ 7.27',
    run: () => calculateExponentialGrowth({ solveFor: 'time', initialQuantity: 100, finalQuantity: 200, growthRate: 10 }),
  },
  {
    slug: 'exponential-growth-calculator',
    name: 'Solve for Initial Quantity (121 at 10% in 2 periods)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'initialQuantity',
    expectedValue: 100,
    tolerance: 0,
    description: 'Solve initial: 121 / (1.1)^2 = 100',
    run: () => calculateExponentialGrowth({ solveFor: 'initial', finalQuantity: 121, growthRate: 10, timePeriods: 2 }),
  },
  {
    slug: 'exponential-growth-calculator',
    name: 'Zero Time (500 at 20% in 0 periods)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'finalQuantity',
    expectedValue: 500,
    tolerance: 0,
    description: 'Zero time keeps value at initial quantity: 500',
    run: () => calculateExponentialGrowth({ solveFor: 'final', initialQuantity: 500, growthRate: 20, timePeriods: 0 }),
  },
  {
    slug: 'exponential-growth-calculator',
    name: 'Negative Time (121 at 10% in -2 periods)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'finalQuantity',
    expectedValue: 100,
    tolerance: 0,
    description: 'Negative time looks into past: 121 * (1.1)^(-2) = 100',
    run: () => calculateExponentialGrowth({ solveFor: 'final', initialQuantity: 121, growthRate: 10, timePeriods: -2 }),
  },
  {
    slug: 'exponential-growth-calculator',
    name: 'Rate below -100% throws error',
    category: 'Boundary',
    expectedBehavior: 'throw',
    expectedResultKey: 'error',
    expectedValue: 'below -100%',
    tolerance: 0,
    description: 'r < -100% produces negative multiplier, which throws.',
    run: () => calculateExponentialGrowth({ solveFor: 'final', initialQuantity: 100, growthRate: -150, timePeriods: 2 }),
  },
];

// ─── Right Triangle Area Calculator Tests ──────────────────────────────────────────
const rightTriangleAreaTests: CalculatorTestCase[] = [
  {
    slug: 'right-triangle-area-calculator',
    name: 'Mode A: Two Legs (a=6, b=8)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'area',
    expectedValue: 24,
    tolerance: 0,
    description: 'Area = (6 * 8) / 2 = 24. Hypotenuse = 10.',
    run: () => calculateRightTriangleArea({ mode: 'two_legs', legA: 6, legB: 8, unit: 'cm' }),
  },
  {
    slug: 'right-triangle-area-calculator',
    name: 'Mode A: Hypotenuse Check (a=6, b=8)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'hypotenuseC',
    expectedValue: 10,
    tolerance: 0,
    description: 'c = sqrt(6^2 + 8^2) = 10.',
    run: () => calculateRightTriangleArea({ mode: 'two_legs', legA: 6, legB: 8, unit: 'cm' }),
  },
  {
    slug: 'right-triangle-area-calculator',
    name: 'Mode B: Leg & Hypotenuse (a=6, c=10)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'legB',
    expectedValue: 8,
    tolerance: 0,
    description: 'b = sqrt(10^2 - 6^2) = 8. Area = 24.',
    run: () => calculateRightTriangleArea({ mode: 'leg_hypotenuse', knownLeg: 'a', legValue: 6, hypotenuseC: 10, unit: 'cm' }),
  },
  {
    slug: 'right-triangle-area-calculator',
    name: 'Mode C: Hypotenuse & Angle (c=10, α=30°)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'area',
    expectedValue: 21.650635,
    tolerance: 0.001,
    description: 'a = 10*sin(30)=5, b=10*cos(30)≈8.66025, Area = (5*8.66025)/2 ≈ 21.650635.',
    run: () => calculateRightTriangleArea({ mode: 'hypotenuse_angle', hypotenuseC: 10, angle: 30, angleType: 'alpha', angleUnit: 'deg', unit: 'cm' }),
  },
  {
    slug: 'right-triangle-area-calculator',
    name: 'Mode C: 45-45-90 Isosceles Case (c=10, α=45°)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'area',
    expectedValue: 25,
    tolerance: 0.001,
    description: 'In 45-45-90: Area = c^2 / 4 = 100 / 4 = 25.',
    run: () => calculateRightTriangleArea({ mode: 'hypotenuse_angle', hypotenuseC: 10, angle: 45, angleType: 'alpha', angleUnit: 'deg', unit: 'cm' }),
  },
  {
    slug: 'right-triangle-area-calculator',
    name: 'Mode D: Leg & Angle (b=10, α=45°)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'area',
    expectedValue: 50,
    tolerance: 0.001,
    description: 'When b=10, α=45: a = 10*tan(45)=10, Area = (10*10)/2 = 50.',
    run: () => calculateRightTriangleArea({ mode: 'leg_angle', knownLeg: 'b', legValue: 10, angle: 45, angleType: 'alpha', angleUnit: 'deg', unit: 'cm' }),
  },
  {
    slug: 'right-triangle-area-calculator',
    name: 'Mode B: Hypotenuse <= Leg Rejection',
    category: 'Boundary',
    expectedBehavior: 'throw',
    expectedResultKey: 'error',
    expectedValue: 'greater than leg',
    tolerance: 0,
    description: 'Hypotenuse must be strictly longer than any leg; c <= leg throws.',
    run: () => calculateRightTriangleArea({ mode: 'leg_hypotenuse', knownLeg: 'a', legValue: 12, hypotenuseC: 10, unit: 'cm' }),
  },
  {
    slug: 'right-triangle-area-calculator',
    name: 'Mode C: Angle >= 90° Rejection',
    category: 'Boundary',
    expectedBehavior: 'throw',
    expectedResultKey: 'error',
    expectedValue: 'between 0° and 90°',
    tolerance: 0,
    description: 'Acute angles in right triangle cannot be 90° or greater.',
    run: () => calculateRightTriangleArea({ mode: 'hypotenuse_angle', hypotenuseC: 10, angle: 90, angleType: 'alpha', angleUnit: 'deg', unit: 'cm' }),
  },
];

// ─── Volume of a Cylinder Calculator Tests ────────────────────────────────────
const cylinderVolumeTests: CalculatorTestCase[] = [
  {
    slug: 'volume-of-a-cylinder-calculator',
    name: 'Standard: Radius 5 cm & Height 10 cm',
    category: 'Known Answer',
    expectedBehavior: 'exact',
    expectedResultKey: 'volume',
    expectedValue: 785.3982,
    tolerance: 0.001,
    description: 'V = π * 5² * 10 = 250π ≈ 785.3982 cm³',
    run: () => calculateStandaloneCylinderVolume({ mode: 'radius_height', lengthUnit: 'cm', volumeUnit: 'cm3', radius: 5, height: 10 }),
  },
  {
    slug: 'volume-of-a-cylinder-calculator',
    name: 'Diameter Mode: Diameter 10 cm & Height 10 cm',
    category: 'Known Answer',
    expectedBehavior: 'exact',
    expectedResultKey: 'volume',
    expectedValue: 785.3982,
    tolerance: 0.001,
    description: 'V = π * 10² * 10 / 4 = 250π ≈ 785.3982 cm³',
    run: () => calculateStandaloneCylinderVolume({ mode: 'diameter_height', lengthUnit: 'cm', volumeUnit: 'cm3', diameter: 10, height: 10 }),
  },
  {
    slug: 'volume-of-a-cylinder-calculator',
    name: 'Hollow Mode: R=6, r=4, h=10',
    category: 'Known Answer',
    expectedBehavior: 'exact',
    expectedResultKey: 'volume',
    expectedValue: 628.3185,
    tolerance: 0.001,
    description: 'V = π * (36 - 16) * 10 = 200π ≈ 628.3185 cm³',
    run: () => calculateStandaloneCylinderVolume({ mode: 'hollow_radius', lengthUnit: 'cm', volumeUnit: 'cm3', outerRadius: 6, innerRadius: 4, height: 10 }),
  },
  {
    slug: 'volume-of-a-cylinder-calculator',
    name: 'Hollow Diameters: D=12, d=8, h=10',
    category: 'Known Answer',
    expectedBehavior: 'exact',
    expectedResultKey: 'volume',
    expectedValue: 628.3185,
    tolerance: 0.001,
    description: 'V = π * (144 - 64) * 10 / 4 = 200π ≈ 628.3185 cm³',
    run: () => calculateStandaloneCylinderVolume({ mode: 'hollow_diameter', lengthUnit: 'cm', volumeUnit: 'cm3', outerDiameter: 12, innerDiameter: 8, height: 10 }),
  },
  {
    slug: 'volume-of-a-cylinder-calculator',
    name: 'Reverse Height: V=785.39816, r=5',
    category: 'Known Answer',
    expectedBehavior: 'exact',
    expectedResultKey: 'height',
    expectedValue: 10,
    tolerance: 0.001,
    description: 'h = V / (π * r²) = 785.39816 / (25π) = 10 cm',
    run: () => calculateStandaloneCylinderVolume({ mode: 'find_height', lengthUnit: 'cm', volumeUnit: 'cm3', volume: 785.3981633974483, radius: 5 }),
  },
  {
    slug: 'volume-of-a-cylinder-calculator',
    name: 'Reverse Radius: V=785.39816, h=10',
    category: 'Known Answer',
    expectedBehavior: 'exact',
    expectedResultKey: 'radius',
    expectedValue: 5,
    tolerance: 0.001,
    description: 'r = √(V / (π * h)) = √(785.39816 / (10π)) = 5 cm',
    run: () => calculateStandaloneCylinderVolume({ mode: 'find_radius', lengthUnit: 'cm', volumeUnit: 'cm3', volume: 785.3981633974483, height: 10 }),
  },
  {
    slug: 'volume-of-a-cylinder-calculator',
    name: 'Oblique Cylinder: Slant L=20, Angle=30°',
    category: 'Known Answer',
    expectedBehavior: 'exact',
    expectedResultKey: 'volume',
    expectedValue: 785.3982,
    tolerance: 0.001,
    description: 'h = 20 * sin(30°) = 10, V = π * 5² * 10 ≈ 785.3982 cm³',
    run: () => calculateStandaloneCylinderVolume({ mode: 'oblique', lengthUnit: 'cm', volumeUnit: 'cm3', radius: 5, obliqueInputType: 'slant_angle', slantLength: 20, slantAngleDeg: 30 }),
  },
  {
    slug: 'volume-of-a-cylinder-calculator',
    name: 'Hollow Validation: R <= r Rejection',
    category: 'Boundary',
    expectedBehavior: 'throw',
    expectedResultKey: 'error',
    expectedValue: 'greater than inner radius',
    tolerance: 0,
    description: 'Outer radius must be strictly greater than inner radius; R <= r throws.',
    run: () => calculateStandaloneCylinderVolume({ mode: 'hollow_radius', lengthUnit: 'cm', volumeUnit: 'cm3', outerRadius: 5, innerRadius: 5, height: 10 }),
  },
  {
    slug: 'volume-of-a-cylinder-calculator',
    name: 'Zero Dimension Rejection',
    category: 'Boundary',
    expectedBehavior: 'throw',
    expectedResultKey: 'error',
    expectedValue: 'positive radius',
    tolerance: 0,
    description: 'Zero radius throws validation error.',
    run: () => calculateStandaloneCylinderVolume({ mode: 'radius_height', lengthUnit: 'cm', volumeUnit: 'cm3', radius: 0, height: 10 }),
  },
];

// ─── Slope Calculator Tests ──────────────────────────────────────────────────
const slopeTests: CalculatorTestCase[] = [
  {
    slug: 'slope-calculator',
    name: 'TEST 1: Rise=5, Run=20 -> 25% Slope',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'slopePercentage',
    expectedValue: 25,
    tolerance: 0.001,
    description: 'm = 5 / 20 = 0.25, Slope % = 25%, Angle ≈ 14.036°',
    run: () => calculateSlope({ mode: 'rise_run', rise: 5, run: 20 }),
  },
  {
    slug: 'slope-calculator',
    name: 'TEST 2: 100% Slope -> 45° Angle',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'angleDeg',
    expectedValue: 45,
    tolerance: 0.001,
    description: 'arctan(100 / 100) = 45.000°',
    run: () => calculateSlope({ mode: 'percentage_to_angle', slopePercentage: 100 }),
  },
  {
    slug: 'slope-calculator',
    name: 'TEST 3: 30° Angle -> ~57.735% Slope',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'slopePercentage',
    expectedValue: 57.735,
    tolerance: 0.01,
    description: 'tan(30°) × 100 ≈ 57.735%',
    run: () => calculateSlope({ mode: 'angle_to_percentage', angleDeg: 30 }),
  },
  {
    slug: 'slope-calculator',
    name: 'TEST 4: Rise=1, Run=20 -> 5% Slope',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'slopePercentage',
    expectedValue: 5,
    tolerance: 0.001,
    description: '1 / 20 × 100 = 5%',
    run: () => calculateSlope({ mode: 'rise_run', rise: 1, run: 20 }),
  },
  {
    slug: 'slope-calculator',
    name: 'TEST 5 (Roof): Rise=6, Run=12 -> 6:12 Pitch (50%, 26.565°)',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'pitchX',
    expectedValue: 6,
    tolerance: 0.001,
    description: 'Rise per 12 units of run = (6 / 12) * 12 = 6, Pitch = 6:12',
    run: () => calculateSlope({ mode: 'roof_rise_run', rise: 6, run: 12 }),
  },
  {
    slug: 'slope-calculator',
    name: 'TEST 6 (Ramp): Rise=0.5m, Target=5% -> Run=10m',
    category: 'Normal',
    expectedBehavior: 'result',
    expectedResultKey: 'run',
    expectedValue: 10,
    tolerance: 0.001,
    description: 'Run = (0.5 * 100) / 5 = 10 m, Surface length = √(0.5² + 10²) ≈ 10.0125 m',
    run: () => calculateSlope({ mode: 'ramp_rise_target', rise: 0.5, targetSlopePercentage: 5, unit: 'm' }),
  },
  {
    slug: 'slope-calculator',
    name: 'Boundary: Zero Horizontal Run Rejection',
    category: 'Boundary',
    expectedBehavior: 'throw',
    expectedResultKey: 'error',
    expectedValue: 'cannot be zero',
    tolerance: 0,
    description: 'Horizontal run cannot be zero.',
    run: () => calculateSlope({ mode: 'rise_run', rise: 10, run: 0 }),
  },
  {
    slug: 'slope-calculator',
    name: 'Boundary: Vertical Angle 90° Rejection',
    category: 'Boundary',
    expectedBehavior: 'throw',
    expectedResultKey: 'error',
    expectedValue: 'strictly between -90° and +90°',
    tolerance: 0,
    description: 'Angle of 90° throws validation error.',
    run: () => calculateSlope({ mode: 'rise_angle', rise: 10, angleDeg: 90 }),
  },
];
...
export const ALL_TEST_CASES: CalculatorTestCase[] = [
  ...
  ...rngTests,
  ...volumeTests,
  ...exponentialFormTests,
  ...exponentialFunctionTests,
  ...exponentialGrowthTests,
  ...rightTriangleAreaTests,
  ...cylinderVolumeTests,
  ...slopeTests,
];
