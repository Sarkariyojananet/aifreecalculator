...
export const LIVE_PAGE_METADATA: Record<string, PageMetaItem> = {
  ...
  "category:free-online-tools": {
    "title": "Free Online Tools - Image, PDF, Text & Developer Utilities",
    "description": "Fast, private, and free browser-based online tools: Image compressor, image resizer, JPG/PNG converter, QR code generator, word counter, JSON formatter, and PDF merge."
  },
  "image-compressor": {
    "title": "Image Compressor - Compress Images Online Free",
    "description": "Compress JPG, PNG, WEBP, and GIF images online without losing quality. Fast, client-side, and private image size reduction."
  },
  "image-resizer": {
    "title": "Image Resizer - Resize Images & Photos Online Free",
    "description": "Resize image dimensions by width, height, or percentage while maintaining aspect ratio directly in your browser."
  },
  "jpg-to-png": {
    "title": "JPG to PNG Converter - Convert JPG Images Online Free",
    "description": "Convert JPG and JPEG images to lossless PNG format directly in your browser with transparent background support."
  },
  "png-to-jpg": {
    "title": "PNG to JPG Converter - Convert PNG Images Online Free",
    "description": "Convert PNG images to JPG format with customizable compression quality for smaller file sizes and fast sharing."
  },
  "qr-code-generator": {
    "title": "QR Code Generator - Create Custom QR Codes Free",
    "description": "Generate custom high-resolution QR codes for websites, plain text, Wi-Fi networks, and contact cards instantly."
  },
  "word-counter": {
    "title": "Word Counter - Count Words, Characters & Reading Time",
    "description": "Count words, characters, sentences, paragraphs, and estimate reading time online in real time with text statistics."
  },
  "json-formatter": {
    "title": "JSON Formatter - Format & Beautify JSON Online",
    "description": "Format, beautify, and inspect raw JSON data with clean indentation, collapsible tree structure, and syntax highlighting."
  },
  "json-validator": {
    "title": "JSON Validator - Validate & Lint JSON Online Free",
    "description": "Validate JSON syntax, detect parsing errors, and identify invalid line numbers instantly in your browser."
  },
  "password-generator": {
    "title": "Password Generator - Create Strong & Secure Passwords",
    "description": "Generate strong, randomized passwords with custom length, uppercase, lowercase, numbers, and special symbol options."
  },
  "pdf-merge": {
